    ...
    <body>
        ...
        <header class = "header">
            ...
            <div class = "middle">
                ...
                <button class = "minus">
                    <img class = "Minus" src = "../images/iconmonstr-minus-circle-lined.svg">
                    <div class = "ToolTip">Remove Data</div>
                </button>
                <input class = "Search" type = "text" placeholder = "Name">
                <button class = "plus">
                    <img class = "Plus" src = "../images/iconmonstr-plus-circle-lined.svg">
                    <div class = "ToolTip">Add New Data</div>
                </button>
            </div>
            <div class = "right">
                <a href = ""><img class = "Advertisement" src = "../images/iconmonstr-compass-12.svg"></a>
